      ...
      >
        ...
        >
          <div className="flex items-center justify-between border-b px-6 py-4">
            ...
            <Button variant="ghost" size="icon" aria-label="Close navigation menu" onClick={closeMenu}>
              <X className="h-5 w-5" />
            </Button>
          </div>
          ...
          <div className="mt-auto border-t px-6 py-6 flex flex-col gap-3">
            <Button variant="ghost" size="lg" className="justify-start" onClick={closeMenu}>
              Sign In
            </Button>
